...
createServer({
    ...
    seeds(server) {
        ...
        server.create("van", {id: "7",name: "Canyon Cruis7",type: "rugged",price:75,description: "Ready for canyon carving and desert roads. Strong build with roof rack and off-road tire7",imageUrl: "https://images.unsplash.com/photo-1640051842021-50324f835a07?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y2FtcGVyJTIwdmFufGVufDB8MnwwfHx8MA%3D%3D"})
        server.create("van", {id: "8",name: "Luxury Traveler",type: "luxury",price: 200,description: "A first-class experience on wheels. Comes with a full kitchen, queen bed, and premium sound system.",imageUrl:"https://images.unsplash.com/photo-1611842117759-e89835e65882?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2FtcGVyJTIwdmFufGVufDB8MnwwfHx8MA%3D%3D"})
        server.create("van", {id: "9",name: "Nomad Rover",type: "rugged",price: 135,description: "Built for the wild. With solar panels and 4WD, it's ready to take you off the grid.",imageUrl: "https://images.unsplash.com/photo-1611842117327-914f196e8c2e?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y2FtcGVyJTIwdmFufGVufDB8MnwwfHx8MA%3D%3D"})
